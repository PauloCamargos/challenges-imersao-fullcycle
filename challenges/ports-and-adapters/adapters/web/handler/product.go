...
import (
	...
	"github.com/PauloCamargos/challenges-imersao-fullcycle/go-hexagonal/adapters/web/dto"
...
func createProduct(service application.ProductServiceInterface) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		boundProduct, err := dtoProduct.Bind(&application.Product{})
		product, err := service.Create(boundProduct.Name, boundProduct.Price)
