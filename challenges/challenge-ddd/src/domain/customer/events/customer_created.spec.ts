...
import SendConsoleLog1WhenCustomerCreatedHandler from "./handler/send_console_log_1_when_customer_created.handler";
import SendConsoleLog2WhenCustomerCreatedHandler from "./handler/send_console_log_2_when_customer_created.handler";
